...
"""autogenerated by genpy from move/DoMoveAction.msg. Do not edit."""
import sys
...
class DoMoveAction(genpy.Message):
  _md5sum = "f0809917d2dde9925150907e877c8bab"
  _type = "move/DoMoveAction"
...
"""
  ...
  _slot_types = ['move/DoMoveActionGoal','move/DoMoveActionResult','move/DoMoveActionFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(DoMoveAction, self).__init__(*args, **kwds)
      #message fields cannot be None, assign default values for those that are
      if self.action_goal is None:
        self.action_goal = move.msg.DoMoveActionGoal()
      if self.action_result is None:
        self.action_result = move.msg.DoMoveActionResult()
      if self.action_feedback is None:
        self.action_feedback = move.msg.DoMoveActionFeedback()
    else:
      self.action_goal = move.msg.DoMoveActionGoal()
      self.action_result = move.msg.DoMoveActionResult()
      self.action_feedback = move.msg.DoMoveActionFeedback()
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      if python3 or type(_x) == unicode:
        ...
        length = len(_x)
      buff.write(struct.pack('<I%ss'%length, length, _x))
      _x = self.action_goal.goal.goal_msg
      length = len(_x)
      if python3 or type(_x) == unicode:
        _x = _x.encode('utf-8')
        length = len(_x)
      ...
      if python3 or type(_x) == unicode:
        ...
        length = len(_x)
      buff.write(struct.pack('<I%ss'%length, length, _x))
      _x = self.action_result.result.result_msg
      length = len(_x)
      if python3 or type(_x) == unicode:
        _x = _x.encode('utf-8')
        length = len(_x)
      ...
      if python3 or type(_x) == unicode:
        ...
        length = len(_x)
      buff.write(struct.pack('<I%ss'%length, length, _x))
      _x = self.action_feedback.feedback.feedback_msg
      length = len(_x)
      if python3 or type(_x) == unicode:
        _x = _x.encode('utf-8')
        length = len(_x)
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      if python3:
        self.action_goal.goal.goal_msg = str[start:end].decode('utf-8')
      else:
        self.action_goal.goal.goal_msg = str[start:end]
      _x = self
      start = end
      end += 12
      ...
      if python3:
        self.action_result.result.result_msg = str[start:end].decode('utf-8')
      else:
        self.action_result.result.result_msg = str[start:end]
      _x = self
      start = end
      end += 12
      ...
      if python3:
        self.action_feedback.feedback.feedback_msg = str[start:end].decode('utf-8')
      else:
        self.action_feedback.feedback.feedback_msg = str[start:end]
      return self
