...
"""autogenerated by genpy from move/DoMoveActionResult.msg. Do not edit."""
import sys
...
class DoMoveActionResult(genpy.Message):
  _md5sum = "ccc271b485e7ce2c82e55f899c7092f0"
  _type = "move/DoMoveActionResult"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','move/DoMoveResult']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(DoMoveActionResult, self).__init__(*args, **kwds)
      ...
      if self.result is None:
        self.result = move.msg.DoMoveResult()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = move.msg.DoMoveResult()
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      if python3:
        self.result.result_msg = str[start:end].decode('utf-8')
      else:
        self.result.result_msg = str[start:end]
      return self
