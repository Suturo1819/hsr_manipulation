// Generated by gencpp from file giskard_msgs/WholeBodyFeedback.msg
// DO NOT EDIT!


#ifndef GISKARD_MSGS_MESSAGE_WHOLEBODYFEEDBACK_H
#define GISKARD_MSGS_MESSAGE_WHOLEBODYFEEDBACK_H
...
struct WholeBodyFeedback_
{
  typedef WholeBodyFeedback_<ContainerAllocator> Type;

  WholeBodyFeedback_()
    : state()  {
    }
  WholeBodyFeedback_(const ContainerAllocator& _alloc)
    : state(_alloc)  {
  (void)_alloc;
    }
  ...
  typedef boost::shared_ptr< ::giskard_msgs::WholeBodyFeedback_<ContainerAllocator> > Ptr;
  typedef boost::shared_ptr< ::giskard_msgs::WholeBodyFeedback_<ContainerAllocator> const> ConstPtr;

}; // struct WholeBodyFeedback_

typedef ::giskard_msgs::WholeBodyFeedback_<std::allocator<void> > WholeBodyFeedback;

typedef boost::shared_ptr< ::giskard_msgs::WholeBodyFeedback > WholeBodyFeedbackPtr;
typedef boost::shared_ptr< ::giskard_msgs::WholeBodyFeedback const> WholeBodyFeedbackConstPtr;
...
std::ostream& operator<<(std::ostream& s, const ::giskard_msgs::WholeBodyFeedback_<ContainerAllocator> & v)
{
ros::message_operations::Printer< ::giskard_msgs::WholeBodyFeedback_<ContainerAllocator> >::stream(s, "", v);
return s;
}
...
template <class ContainerAllocator>
struct IsFixedSize< ::giskard_msgs::WholeBodyFeedback_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::giskard_msgs::WholeBodyFeedback_<ContainerAllocator> const>
  : FalseType
  { };

template <class ContainerAllocator>
struct IsMessage< ::giskard_msgs::WholeBodyFeedback_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::giskard_msgs::WholeBodyFeedback_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::giskard_msgs::WholeBodyFeedback_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct HasHeader< ::giskard_msgs::WholeBodyFeedback_<ContainerAllocator> const>
  : FalseType
  { };


template<class ContainerAllocator>
struct MD5Sum< ::giskard_msgs::WholeBodyFeedback_<ContainerAllocator> >
{
  ...
  static const char* value(const ::giskard_msgs::WholeBodyFeedback_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0x116144890e2eab71ULL;
  static const uint64_t static_value2 = 0xae9010a22d3d9149ULL;
};

template<class ContainerAllocator>
struct DataType< ::giskard_msgs::WholeBodyFeedback_<ContainerAllocator> >
{
  static const char* value()
  {
...
template<class ContainerAllocator>
struct Definition< ::giskard_msgs::WholeBodyFeedback_<ContainerAllocator> >
{
  static const char* value()
  {
...
namespace serialization
{
  ...
  template<class ContainerAllocator> struct Serializer< ::giskard_msgs::WholeBodyFeedback_<ContainerAllocator> >
  {
...
template<class ContainerAllocator>
struct Printer< ::giskard_msgs::WholeBodyFeedback_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::giskard_msgs::WholeBodyFeedback_<ContainerAllocator>& v)
  {
    s << indent << "state: ";
    s << std::endl;
...
#endif // GISKARD_MSGS_MESSAGE_WHOLEBODYFEEDBACK_H
