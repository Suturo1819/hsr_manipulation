// Generated by gencpp from file giskard_msgs/MoveActionGoal.msg
// DO NOT EDIT!


#ifndef GISKARD_MSGS_MESSAGE_MOVEACTIONGOAL_H
#define GISKARD_MSGS_MESSAGE_MOVEACTIONGOAL_H
...
#include <giskard_msgs/MoveGoal.h>
...
struct MoveActionGoal_
{
  ...
  _goal_id_type goal_id;
   ...
   typedef  ::giskard_msgs::MoveGoal_<ContainerAllocator>  _goal_type;
  _goal_type goal;
  ...
  typedef boost::shared_ptr< ::giskard_msgs::MoveActionGoal_<ContainerAllocator> > Ptr;
  typedef boost::shared_ptr< ::giskard_msgs::MoveActionGoal_<ContainerAllocator> const> ConstPtr;

}; // struct MoveActionGoal_

typedef ::giskard_msgs::MoveActionGoal_<std::allocator<void> > MoveActionGoal;

typedef boost::shared_ptr< ::giskard_msgs::MoveActionGoal > MoveActionGoalPtr;
typedef boost::shared_ptr< ::giskard_msgs::MoveActionGoal const> MoveActionGoalConstPtr;
...
std::ostream& operator<<(std::ostream& s, const ::giskard_msgs::MoveActionGoal_<ContainerAllocator> & v)
{
ros::message_operations::Printer< ::giskard_msgs::MoveActionGoal_<ContainerAllocator> >::stream(s, "", v);
return s;
}
...
template <class ContainerAllocator>
struct IsFixedSize< ::giskard_msgs::MoveActionGoal_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::giskard_msgs::MoveActionGoal_<ContainerAllocator> const>
  : FalseType
  { };

template <class ContainerAllocator>
struct IsMessage< ::giskard_msgs::MoveActionGoal_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::giskard_msgs::MoveActionGoal_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::giskard_msgs::MoveActionGoal_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::giskard_msgs::MoveActionGoal_<ContainerAllocator> const>
  : TrueType
  { };


template<class ContainerAllocator>
struct MD5Sum< ::giskard_msgs::MoveActionGoal_<ContainerAllocator> >
{
  static const char* value()
  {
    return "cbcb6b23a2ce39eb61463e4f4ea36864";
  }

  static const char* value(const ::giskard_msgs::MoveActionGoal_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0xcbcb6b23a2ce39ebULL;
  static const uint64_t static_value2 = 0x61463e4f4ea36864ULL;
};

template<class ContainerAllocator>
struct DataType< ::giskard_msgs::MoveActionGoal_<ContainerAllocator> >
{
  static const char* value()
  {
    return "giskard_msgs/MoveActionGoal";
  }
...
template<class ContainerAllocator>
struct Definition< ::giskard_msgs::MoveActionGoal_<ContainerAllocator> >
{
  static const char* value()
  {
...
namespace serialization
{
  ...
  template<class ContainerAllocator> struct Serializer< ::giskard_msgs::MoveActionGoal_<ContainerAllocator> >
  {
...
template<class ContainerAllocator>
struct Printer< ::giskard_msgs::MoveActionGoal_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::giskard_msgs::MoveActionGoal_<ContainerAllocator>& v)
  {
    s << indent << "header: ";
    s << std::endl;
    ...
    s << indent << "goal: ";
    s << std::endl;
    Printer< ::giskard_msgs::MoveGoal_<ContainerAllocator> >::stream(s, indent + "  ", v.goal);
  }
};
...
#endif // GISKARD_MSGS_MESSAGE_MOVEACTIONGOAL_H
