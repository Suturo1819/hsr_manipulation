...
"""autogenerated by genpy from giskard_msgs/SemanticFloat64Array.msg. Do not edit."""
import sys
...
class SemanticFloat64Array(genpy.Message):
  _md5sum = "96b61963e755db3864fbf71022c3fb5f"
  _type = "giskard_msgs/SemanticFloat64Array"
  _has_header = False #flag to mark the presence of a Header object
  _full_text = """# An array floating-point with semantics hint attached.
...
"""
  __slots__ = ['data']
  _slot_types = ['giskard_msgs/SemanticFloat64[]']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(SemanticFloat64Array, self).__init__(*args, **kwds)
