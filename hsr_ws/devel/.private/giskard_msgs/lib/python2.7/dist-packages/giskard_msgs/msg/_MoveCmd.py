...
"""autogenerated by genpy from giskard_msgs/MoveCmd.msg. Do not edit."""
import sys
...
class MoveCmd(genpy.Message):
  _md5sum = "60b77fd43284c921383c3d2e3bc7bf84"
  _type = "giskard_msgs/MoveCmd"
  _has_header = False #flag to mark the presence of a Header object
  _full_text = """# Set of controllers that need to converge for this command to finish
...
"""
  __slots__ = ['controllers','collisions']
  _slot_types = ['giskard_msgs/Controller[]','giskard_msgs/CollisionEntry[]']
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      for val1 in self.collisions:
        ...
        length = len(val1.robot_links)
        buff.write(_struct_I.pack(length))
        for val2 in val1.robot_links:
          length = len(val2)
        ...
        if python3 or type(_x) == unicode:
          ...
          length = len(_x)
        buff.write(struct.pack('<I%ss'%length, length, _x))
        length = len(val1.link_bs)
        buff.write(_struct_I.pack(length))
        for val2 in val1.link_bs:
          length = len(val2)
          if python3 or type(val2) == unicode:
            val2 = val2.encode('utf-8')
            length = len(val2)
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      self.collisions = []
      for i in range(0, length):
        val1 = giskard_msgs.msg.CollisionEntry()
        _x = val1
        start = end
        end += 9
        ...
        if python3:
          val1.body_b = str[start:end].decode('utf-8')
        else:
