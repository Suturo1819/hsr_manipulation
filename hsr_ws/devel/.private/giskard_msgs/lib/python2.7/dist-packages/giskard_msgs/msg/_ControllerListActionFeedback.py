...
"""autogenerated by genpy from giskard_msgs/ControllerListActionFeedback.msg. Do not edit."""
import sys
...
class ControllerListActionFeedback(genpy.Message):
  _md5sum = "49086203914886b08882e34b918ff907"
  _type = "giskard_msgs/ControllerListActionFeedback"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','giskard_msgs/ControllerListFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(ControllerListActionFeedback, self).__init__(*args, **kwds)
      ...
      if self.feedback is None:
        self.feedback = giskard_msgs.msg.ControllerListFeedback()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.feedback = giskard_msgs.msg.ControllerListFeedback()
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      if python3 or type(_x) == unicode:
        ...
        length = len(_x)
      buff.write(struct.pack('<I%ss'%length, length, _x))
      buff.write(_get_struct_d().pack(self.feedback.progress))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (self.feedback.progress,) = _get_struct_d().unpack(str[start:end])
      return self
