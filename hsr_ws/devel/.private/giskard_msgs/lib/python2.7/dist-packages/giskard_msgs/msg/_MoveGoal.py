...
"""autogenerated by genpy from giskard_msgs/MoveGoal.msg. Do not edit."""
import sys
...
class MoveGoal(genpy.Message):
  _md5sum = "7685ad046c30e10022bb0be6996adff9"
  _type = "giskard_msgs/MoveGoal"
...
"""
  ...
  __slots__ = ['type','cmd_seq']
  _slot_types = ['uint8','giskard_msgs/MoveCmd[]']
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      length = len(self.cmd_seq)
      buff.write(_struct_I.pack(length))
      for val1 in self.cmd_seq:
