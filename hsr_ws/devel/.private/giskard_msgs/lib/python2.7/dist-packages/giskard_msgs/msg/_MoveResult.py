...
"""autogenerated by genpy from giskard_msgs/MoveResult.msg. Do not edit."""
import sys
...
class MoveResult(genpy.Message):
  _md5sum = "30a5ca36aa9d78817486028053bcba3f"
  _type = "giskard_msgs/MoveResult"
...
"""
  ...
  __slots__ = ['error_code','trajectory']
  _slot_types = ['uint8','trajectory_msgs/JointTrajectory']
  ...
  def serialize(self, buff):
    ...
    try:
      _x = self
      buff.write(_get_struct_B3I().pack(_x.error_code, _x.trajectory.header.seq, _x.trajectory.header.stamp.secs, _x.trajectory.header.stamp.nsecs))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.error_code, _x.trajectory.header.seq, _x.trajectory.header.stamp.secs, _x.trajectory.header.stamp.nsecs,) = _get_struct_B3I().unpack(str[start:end])
      start = end
      end += 4
