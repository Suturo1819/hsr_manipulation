...
"""autogenerated by genpy from giskard_msgs/MoveActionFeedback.msg. Do not edit."""
import sys
...
class MoveActionFeedback(genpy.Message):
  _md5sum = "b77946a7bb59a3b9d9ee2af826c71d36"
  _type = "giskard_msgs/MoveActionFeedback"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','giskard_msgs/MoveFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.feedback is None:
        self.feedback = giskard_msgs.msg.MoveFeedback()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.feedback = giskard_msgs.msg.MoveFeedback()
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      buff.write(struct.pack('<I%ss'%length, length, _x))
      _x = self
      buff.write(_get_struct_Bd().pack(_x.feedback.phase, _x.feedback.progress))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.feedback.phase, _x.feedback.progress,) = _get_struct_Bd().unpack(str[start:end])
      return self
