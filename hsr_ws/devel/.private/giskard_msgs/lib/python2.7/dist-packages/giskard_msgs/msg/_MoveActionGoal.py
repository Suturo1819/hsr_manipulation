...
"""autogenerated by genpy from giskard_msgs/MoveActionGoal.msg. Do not edit."""
import sys
...
class MoveActionGoal(genpy.Message):
  _md5sum = "cbcb6b23a2ce39eb61463e4f4ea36864"
  _type = "giskard_msgs/MoveActionGoal"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalID','giskard_msgs/MoveGoal']
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.goal is None:
        self.goal = giskard_msgs.msg.MoveGoal()
    else:
      self.header = std_msgs.msg.Header()
      self.goal_id = actionlib_msgs.msg.GoalID()
      self.goal = giskard_msgs.msg.MoveGoal()
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      length = len(self.goal.cmd_seq)
      buff.write(_struct_I.pack(length))
      for val1 in self.goal.cmd_seq:
