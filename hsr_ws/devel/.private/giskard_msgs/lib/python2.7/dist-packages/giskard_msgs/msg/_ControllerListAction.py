...
"""autogenerated by genpy from giskard_msgs/ControllerListAction.msg. Do not edit."""
import sys
...
class ControllerListAction(genpy.Message):
  _md5sum = "7c51059c89604bf8d8a2f4497e225cfa"
  _type = "giskard_msgs/ControllerListAction"
...
"""
  ...
  _slot_types = ['giskard_msgs/ControllerListActionGoal','giskard_msgs/ControllerListActionResult','giskard_msgs/ControllerListActionFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(ControllerListAction, self).__init__(*args, **kwds)
      #message fields cannot be None, assign default values for those that are
      if self.action_goal is None:
        self.action_goal = giskard_msgs.msg.ControllerListActionGoal()
      if self.action_result is None:
        self.action_result = giskard_msgs.msg.ControllerListActionResult()
      if self.action_feedback is None:
        self.action_feedback = giskard_msgs.msg.ControllerListActionFeedback()
    else:
      self.action_goal = giskard_msgs.msg.ControllerListActionGoal()
      self.action_result = giskard_msgs.msg.ControllerListActionResult()
      self.action_feedback = giskard_msgs.msg.ControllerListActionFeedback()
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      length = len(self.action_goal.goal.controllers)
      buff.write(_struct_I.pack(length))
      for val1 in self.action_goal.goal.controllers:
      ...
      if python3 or type(_x) == unicode:
        ...
        length = len(_x)
      buff.write(struct.pack('<I%ss'%length, length, _x))
      buff.write(_get_struct_d().pack(self.action_feedback.feedback.progress))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (length,) = _struct_I.unpack(str[start:end])
      self.action_goal.goal.controllers = []
      for i in range(0, length):
        ...
        self.action_goal.goal.controllers.append(val1)
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
      ...
      if python3:
        self.action_goal.goal.yaml = str[start:end].decode('utf-8')
      else:
        self.action_goal.goal.yaml = str[start:end]
      _x = self
      start = end
      end += 12
      ...
      (self.action_feedback.feedback.progress,) = _get_struct_d().unpack(str[start:end])
      return self
