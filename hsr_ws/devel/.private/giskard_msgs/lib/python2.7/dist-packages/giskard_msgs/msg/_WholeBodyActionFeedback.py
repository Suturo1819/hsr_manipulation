...
"""autogenerated by genpy from giskard_msgs/WholeBodyActionFeedback.msg. Do not edit."""
import sys
...
class WholeBodyActionFeedback(genpy.Message):
  _md5sum = "2fe8120d0c8b84b43b3d8eacae55a6a4"
  _type = "giskard_msgs/WholeBodyActionFeedback"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','giskard_msgs/WholeBodyFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(WholeBodyActionFeedback, self).__init__(*args, **kwds)
      ...
      if self.feedback is None:
        self.feedback = giskard_msgs.msg.WholeBodyFeedback()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.feedback = giskard_msgs.msg.WholeBodyFeedback()
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      buff.write(struct.pack('<I%ss'%length, length, _x))
      _x = self
      buff.write(_get_struct_2i3d().pack(_x.feedback.state.running_time.secs, _x.feedback.state.running_time.nsecs, _x.feedback.state.left_arm_max_vel, _x.feedback.state.right_arm_max_vel, _x.feedback.state.torso_vel))
      length = len(self.feedback.state.convergence_values)
      buff.write(_struct_I.pack(length))
      for val1 in self.feedback.state.convergence_values:
        _x = val1.semantics
        length = len(_x)
        if python3 or type(_x) == unicode:
          _x = _x.encode('utf-8')
      ...
      _x = self
      buff.write(_get_struct_5B().pack(_x.feedback.state.motion_started, _x.feedback.state.motion_old, _x.feedback.state.torso_moving, _x.feedback.state.left_arm_moving, _x.feedback.state.right_arm_moving))
      length = len(self.feedback.state.convergence_flags)
      buff.write(_struct_I.pack(length))
      for val1 in self.feedback.state.convergence_flags:
        _x = val1.semantics
        length = len(_x)
        if python3 or type(_x) == unicode:
          _x = _x.encode('utf-8')
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.feedback.state.running_time.secs, _x.feedback.state.running_time.nsecs, _x.feedback.state.left_arm_max_vel, _x.feedback.state.right_arm_max_vel, _x.feedback.state.torso_vel,) = _get_struct_2i3d().unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      self.feedback.state.convergence_values = []
      for i in range(0, length):
        ...
        self.feedback.state.convergence_values.append(val1)
      _x = self
      start = end
      end += 5
      (_x.feedback.state.motion_started, _x.feedback.state.motion_old, _x.feedback.state.torso_moving, _x.feedback.state.left_arm_moving, _x.feedback.state.right_arm_moving,) = _get_struct_5B().unpack(str[start:end])
      self.feedback.state.motion_started = bool(self.feedback.state.motion_started)
      self.feedback.state.motion_old = bool(self.feedback.state.motion_old)
      self.feedback.state.torso_moving = bool(self.feedback.state.torso_moving)
      self.feedback.state.left_arm_moving = bool(self.feedback.state.left_arm_moving)
      self.feedback.state.right_arm_moving = bool(self.feedback.state.right_arm_moving)
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      self.feedback.state.convergence_flags = []
      for i in range(0, length):
        ...
        self.feedback.state.convergence_flags.append(val1)
      return self
