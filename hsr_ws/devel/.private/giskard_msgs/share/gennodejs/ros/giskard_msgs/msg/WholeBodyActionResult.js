...
let WholeBodyResult = require('./WholeBodyResult.js');
let actionlib_msgs = _finder('actionlib_msgs');
let std_msgs = _finder('std_msgs');

//-----------------------------------------------------------

class WholeBodyActionResult {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      if (initObj.hasOwnProperty('result')) {
        ...
        this.result = new WholeBodyResult();
      }
    }
  }
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = WholeBodyResult.serialize(obj.result, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static getMessageSize(object) {
    ...
    length += WholeBodyResult.getMessageSize(object.result);
    return length;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new WholeBodyActionResult(null);
    ...
    if (msg.result !== undefined) {
      resolved.result = WholeBodyResult.Resolve(msg.result)
    }
    else {
      resolved.result = new WholeBodyResult()
    }
...
module.exports = WholeBodyActionResult;
